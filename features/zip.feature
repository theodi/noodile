...
Feature: generate zipped output files
  ...
  Background: setup the sample data file
    ...
    "410","AAA","South West","BBB","Wales","0001533F-716C-E111-90C3-0050569D002D","AAABBB",2012-03-13 16:47:15,2015-04-03,36,10,6.41,"Individual","AAACCC","Zopa","AAA","BBB","DDD","CCC"
    """

  @no-postcodes
  Scenario: one without postcodes
    When I successfully run `noodile --zip sample.csv`
    Then a 410 byte file named "outputs/complete.no.postcodes.csv.zip" should exist
